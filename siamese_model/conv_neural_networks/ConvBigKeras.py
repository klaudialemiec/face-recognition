...
def faceRecoModel_Big(input_shape):
    """
    Implementation of the Inception siamese_model used for FaceNet

    Arguments:
    input_shape -- shape of the images of the dataset
    Returns:
    siamese_model -- a Model() instance in Keras
    """
